  ...
  return (
    ...
    >
      <svg
        ...
        className="h-6 w-6 fill-neutral-800 dark:fill-neutral-100"
      >
        <title>Twitter</title>
...
export const LinkedinSvg = () => {
  return (
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="rounded p-2 hover:bg-purple-700"
    >
      <svg
        role="img"
        viewBox="0 0 24 24"
...
export const GithubSvg = () => {
  return (
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="rounded p-2 hover:bg-blue-600"
    >
      <svg
        role="img"
        viewBox="0 0 24 24"
...
export const LinkSvg = () => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className="h-6 w-6 stroke-neutral-800 dark:stroke-neutral-100"
      fill="none"
      viewBox="0 0 24 24"
      stroke="currentColor"
      strokeWidth={2}
